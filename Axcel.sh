#!/bin/bash
# ============================================================
# LAURENCE PROJECT - PTERODACTYL THEME INSTALLER & VPS INFO
# ============================================================
# Author  : Laurence Project
# Telegram: @LaurenceVill
...
show_banner() {
  ...
  echo -e "${BRIGHT_MAGENTA}${BOLD}║${NC}          ${BRIGHT_GREEN}✨ Author: Laurence Project ✨${NC}          ${BRIGHT_MAGENTA}${BOLD}║${NC}"
  echo -e "${BRIGHT_MAGENTA}${BOLD}║${NC}          ${BRIGHT_GREEN}📱 Telegram: @LaurenceChs${NC}          ${BRIGHT_MAGENTA}${BOLD}║${NC}"
  echo -e "${BRIGHT_MAGENTA}${BOLD}║${NC}          ${BRIGHT_GREEN}🌐 Version: 1.0 FULL${NC}          ${BRIGHT_MAGENTA}${BOLD}║${NC}"
  echo -e "${BRIGHT_MAGENTA}${BOLD}║                                                          ║${NC}"
  echo -e "${BRIGHT_MAGENTA}${BOLD}╚══════════════════════════════════════════════════════════╝${NC}"
  echo -e ""
}
...
show_menu_header() {
  echo -e "${BRIGHT_MAGENTA}${BOLD}┌──────────────────────────────────────────────────────────┐${NC}"
  echo -e "${BRIGHT_MAGENTA}${BOLD}│${NC}              ${BRIGHT_YELLOW}☯ LAURENCE PROJECT - MAIN MENU ☯${NC}               ${BRIGHT_MAGENTA}${BOLD}│${NC}"
  echo -e "${BRIGHT_MAGENTA}${BOLD}├──────────────────────────────────────────────────────────┤${NC}"
}
...
check_vps_spec() {
  ...
  # ===== FOOTER =====
  echo -e "${BLUE}═══════════════════════════════════════════════════════════════════${NC}"
  echo -e "${YELLOW}Telegram :${NC} ${CYAN}t.me/LaurenceVill${NC}"
  echo -e "${YELLOW}Youtube  :${NC} ${RED}https://www.youtube.com/@LaurenceVill${NC}"
  echo -e "${YELLOW}TikTok   :${NC} ${PURPLE}tiktok.com/@LaurenceVill${NC}"
  echo -e "${BLUE}═══════════════════════════════════════════════════════════════════${NC}"
  ...
  while true; do
    ...
    case "$MENU_CHOICE" in
      ...
      x|X) 
        ...
        echo -e "${BRIGHT_GREEN}${BOLD}║        LAURENCE PROJECT!                      ║${NC}"
        echo -e "${BRIGHT_GREEN}${BOLD}║                                            ║${NC}"
        echo -e "${BRIGHT_GREEN}${BOLD}║   Telegram: @LaurenceChs                 ║${NC}"
        echo -e "${BRIGHT_GREEN}${BOLD}╚════════════════════════════════════════════╝${NC}"
        echo ""
        exit 0 
        ;;
